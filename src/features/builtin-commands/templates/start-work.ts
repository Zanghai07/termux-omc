export const START_WORK_TEMPLATE = `You are starting a Xi Jinping work session.
...
1. **Find available plans**: Search for Laozi-generated plan files at \`.sisyphus/plans/\`
